...
export default class MockPersistanceLayer {
    ...
    load() {
        return [
            ...
            new Setting(5, 'groupe1.param3', 'Troisième test', 'String', null, null, false, true, "", false, "1/4", localeSettings.locale.groupe1.sousgroupe1.param1_label, localeSettings.locale.groupe1.sousgroupe1.param1_text),
            ...
            ], false, true, "", false, "1/4", localeSettings.locale.groupe1.sousgroupe1.param1_label, localeSettings.locale.groupe1.sousgroupe1.param1_text),
